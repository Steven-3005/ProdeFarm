...
AS
BEGIN
	SELECT TM_USUARIO.USU_ID, TM_USUARIO.SUC_ID, TM_USUARIO.USU_CORREO, TM_USUARIO.USU_NOM, 
	TM_USUARIO.USU_APE, TM_USUARIO.USU_CI, TM_USUARIO.USU_TELF, TM_USUARIO.USU_PASS, TM_USUARIO.ROL_ID, 
    TM_USUARIO.FECH_CREA, TM_USUARIO.EST, TM_ROL.ROL_NOM
