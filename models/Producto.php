<?php
    class Producto extends Conectar{
       ...
       public function insert_producto($suc_id,$cat_id,$prod_nom,$prod_descrip,$und_id,$prod_pcompra,$prod_pventa,$prod_stock,$prod_fechaven,$prod_img){
        $conectar=parent::Conexion();
       ...
       public function update_producto($prod_id,$suc_id,$cat_id,$prod_nom,$prod_descrip,$und_id,$prod_pcompra,$prod_pventa,$prod_stock,$prod_fechaven,$prod_img){
        $conectar=parent::Conexion();
