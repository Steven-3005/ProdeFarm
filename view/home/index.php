...
<div class="row">
    <div class="col">
        ...
        <div class="h-100">
                ...
                <div class="col-12">
                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                        <div class="flex-grow-1">
                            <h4 class="fs-16 mb-1">Saludos, <?php echo $_SESSION["USU_NOM"]?>!</h4>
                            <p class="text-muted mb-0">Lo sucedido del día de hoy</p>
                        </div>
            ...
            <!-- TODO: VENTAS Y COMPRAS RECIENTES -->
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Ventas Recientes</h4>
                        </div>
