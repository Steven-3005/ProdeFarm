    ...
    switch($_GET["op"]){
        ...
        case "listarventa":
            ...
            foreach($datos as $row){
                ...
                $sub_array[] = '<button type="button" onClick="ver('.$row["VENT_ID"].')" id="'.$row["VENT_ID"].'" class="btn btn-success btn-icon waves-effect waves-light"><i class="ri-todo-line"></i></button>';
                $data[] = $sub_array;
            }
